...
public class Pin extends JFrame implements ActionListener{
    ...
    Pin(String pin){
        ...
        l1.setBounds(240,260,700,20);
        l4.add(l1);
        
        l2.setBounds(144,300,150,35);
        l4.add(l2);
        
        l3.setBounds(144,340,200,35);
        l4.add(l3);
        
        t1.setBounds(274,304,180,25);
        l4.add(t1);
        
        t2.setBounds(274,346,180,25);
        l4.add(t2);
        
        b1.setBounds(320,410,140,35);
        l4.add(b1);
        
        b2.setBounds(320,450,140,35);
        l4.add(b2);
